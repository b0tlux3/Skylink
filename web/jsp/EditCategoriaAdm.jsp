...
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
                 <title>EDITAR CATEGORIA GENERAL - ADMIN</title>
    ...
    <body>
        ...
        <h1 align = "center"> Editar Categoria ADM - Skylink </h1>
        <br>
         <ul class="nav navbar-nav navbar-center">
                ...
                <li>
                    ...
                    <form method="POST" action="http://localhost:8082/SkylinkWeb2/categoriaControllerAdm">
                        ...
                        <button colspan="2" align="center" type="submit" value="Ingresar" class="btn btn-primary btn-md" >Listado Categorias<span class="pull-left hidden-xs showopacity fas fa-users" style="font-size: 20px; padding-right: 5px;"></span></button>
                    </form>
        ...
        <div class = "container" style="width: 600px; margin: 0 auto;">
            <div class = "panel panel-primary">
                <div class = "panel-heading"> Formulario para Editar Categorias</div>
                <div class = "panel-body ">
                    <form method="POST" action="../categoriaControllerAdm">
                        <input type="hidden" name="accion" value = "goEditarCategoria">
                        <%
                        ...
                        <p>
                            ...
                            <input id="nomCategoria" name="nomCategoria" type="text" placeholder="ingrese precio" class="form-control input-md" required="" value="<%=nomCategoria%>">
                        </p>
